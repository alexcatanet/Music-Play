...
public class Chill_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceStace) {
        ...
        tracks.add(new Track("Above & Beyond", "Common Ground", R.drawable.chill_1));
        tracks.add(new Track("Above & Beyond", "Common Ground"));
        tracks.add(new Track("Above & Beyond", "Common Ground"));
        tracks.add(new Track("Above & Beyond", "Common Ground"));
        tracks.add(new Track("Above & Beyond", "Common Ground"));
        tracks.add(new Track("Above & Beyond", "Common Ground"));
